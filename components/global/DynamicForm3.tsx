...
//       (acc, field) => ({
//         ...acc,
//         [field.name]: field.type === "multi-select" || field.type === "dropdown-multi-select" ? [] : field.type === "checkbox-grid" ? field.checkboxGrid || [] : "",
//       }),
//       {}
//     ),
...
//   // Handle multi-select changes (checkbox-based)
    ...
    >
      {fields.map((field) => (
        <div
          ...
          style={customStyles.fieldWrapper}
        >
          <label htmlFor={field.name} style={customStyles.label}>
            {field.label}
          </label>
